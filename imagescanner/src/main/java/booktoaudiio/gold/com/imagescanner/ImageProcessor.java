...
import booktoaudiio.gold.com.imagescanner.helpers.Quadrilateral;
import booktoaudiio.gold.com.imagescanner.helpers.ScannedDocument;
import booktoaudiio.gold.com.imagescanner.helpers.Utils;
...
public class ImageProcessor extends Handler {
    ...
    public void processPicture( Mat picture ) {
        ...
        Mat img = Imgcodecs.imdecode(picture, Imgcodecs.IMREAD_UNCHANGED);   //CV_LOAD_IMAGE_UNCHANGED
        picture.release();
