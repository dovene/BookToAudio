package booktoaudiio.gold.com.imagescanner.helpers;
...
import booktoaudiio.gold.com.imagescanner.R;
...
public class CustomOpenCVLoader extends OpenCVLoader {
    ...
    public static boolean initAsync(String version, final Context AppContext, LoaderCallbackInterface callback) {
       ...
       /* if (!isOpenCVInstalled(Version,AppContext)) {
            ...
            if (isNonPlayAppAllowed) {
                askInstallOpenCV.setNeutralButton(R.string.githubdownload, new DialogInterface.OnClickListener() {
                 ...
                 //   String arch = Build.SUPPORTED_ABIS[0]; //TODO Only for api above 21

                    public void onClick(DialogInterface dialog, int which) {

                        String sAndroidUrl = "https://github.com/ctodobom/opencv/releases/download/3.1.0/OpenCV_3.1.0_Manager_3.10_" ; //+ arch + ".apk"////TODO Only for api above 21;
                        ...
                        String sDest = "file://" + android.os.Environment.getExternalStorageDirectory().toString() + "/Download/OpenCV_3.1.0_Manager_3.10_"
                                //TODO Only for api above 21 + arch
                                + ".apk";
       ...
       return OpenCVLoader.initAsync(OpenCVLoader.OPENCV_VERSION, AppContext, Callback);
