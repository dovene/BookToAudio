package booktoaudiio.gold.com.imagescanner.views;
...
public class TagEditorFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for ( int i=0 ; i<7 ; i++ ) {
            ...
            //TODO Only for api above 21 //stdTagsButtons[i].setBackgroundTintList(ColorStateList.valueOf( stdTagsState[i] ? 0xFF00E676 : 0xFFa0a0a0 ));
            ...
            stdTagsButtons[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //TODO Only for api above 21 // v.setBackgroundTintList(ColorStateList.valueOf( stdTagsState[index] ? 0xFF00E676 : 0xFFa0a0a0 ));
                }
            });
        }
